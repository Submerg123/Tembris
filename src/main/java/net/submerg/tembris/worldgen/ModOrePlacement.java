...
public class ModOrePlacement {
    public static List<PlacementModifier> orePlacement(PlacementModifier placement, PlacementModifier heightRange) {
        return List.of(placement, InSquarePlacement.spread(), heightRange, BiomeFilter.biome());
    }
